    ...
    <section className="relative py-16 sm:py-24 lg:py-32 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Message Card */}
          <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/50 p-6 sm:p-8 shadow-xl glass-backdrop backdrop-blur-md animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col items-center text-center">
                <p className="mb-5 text-base font-medium text-foreground/80">
                ...
                <div className="flex flex-col items-center gap-3">
                  <Button 
                    size="lg" 
                    className="h-12 px-7 text-base bg-primary text-primary-foreground hover:bg-primary/90 btn-glow shadow-lg shadow-primary/20"
                    asChild
                  >
