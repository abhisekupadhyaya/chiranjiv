        ...
        <div className="px-3 sm:px-4 md:px-6">
          <div className={`flex items-center justify-between transition-all duration-300 ${scrolled ? 'h-12 sm:h-14 md:h-14' : 'h-14 sm:h-16 md:h-14'}`}>
            ...
            <div className="hidden md:flex items-center gap-6 lg:gap-8">
              ...
              <Link to="/careers" className="text-sm font-medium tracking-tight text-muted-foreground hover:text-foreground transition-all duration-200 nav-link-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-md px-2 py-1">Careers</Link>
              ...
              <Dialog.Root open={open} onOpenChange={(isOpen) => { setOpen(isOpen); if (!isOpen) setAboutUsOpen(false); }}>
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="fixed inset-y-0 left-0 z-[101] w-80 max-w-[85vw] glass-backdrop border-r border-border/50 shadow-2xl p-6 flex flex-col gap-4 outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:slide-in-from-left data-[state=closed]:slide-out-to-left">
                    ...
                    <Link to="/careers" className="px-3 py-2.5 text-sm font-medium tracking-tight rounded-lg hover:bg-muted/50 nav-link-hover transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background" aria-current={location.pathname.startsWith('/careers') ? 'page' : undefined} onClick={() => setOpen(false)}>
                      Careers
                    </Link>
