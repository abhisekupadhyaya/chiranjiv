...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 sm:pt-32 pb-20 sm:pb-28 hero-section">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl hero-headline text-foreground mb-6 sm:mb-8 md:mb-10 text-balance font-extralight leading-[1.1] tracking-tight">
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-32 sm:mb-40 md:mb-48 mx-auto text-pretty leading-relaxed max-w-3xl font-light">
