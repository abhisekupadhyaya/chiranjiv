...
import { BlogPost as Post } from '@/components/BlogPost'

export default function KnowledgeHubPost() {
  const { slug } = useParams()

  // Helper to render the post layout
  const renderPost = (blogPost: { title: string; date: string; content: string }) => (
    <main className="relative w-full min-h-screen overflow-hidden">
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24">
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <div className="mb-8">
            <p className="text-[11px] sm:text-xs uppercase tracking-[0.2em] text-primary-600/70 mb-4">Knowledge Hub</p>
            <Link
              to="/knowledge-hub"
