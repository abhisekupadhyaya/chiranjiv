  ...
  return (
    ...
    >
      ...
      <section id="classification" className="mb-8">
        <p className="mb-4 leading-relaxed">
          <strong>3. Data Classification.</strong> All Rapidera Data shall be classified into one of the following categories:
        </p>
        
        <ol className="list-[lower-alpha] list-outside ml-6 space-y-3 mb-4">
          <li>
            <strong>Public Data:</strong> Information that has been specifically approved for public disclosure and would not harm Rapidera if released, such as published marketing materials and public announcements.
          </li>
          <li>
            <strong>Internal Data:</strong> Information intended for use within Rapidera that is not confidential but should not be shared externally without proper authorization, such as internal policies, general business communications, and organizational charts.
          </li>
          <li>
            <strong>Confidential Data:</strong> Sensitive business information that could cause harm to Rapidera if disclosed inappropriately, such as business strategies, vendor contracts, employee performance reviews, and customer lists.
          </li>
          <li>
      ...
      <section id="permitted-uses" className="mb-8">
        <p className="mb-4 leading-relaxed">
          <strong>4. Permitted Uses.</strong> Users are authorized to access and use Rapidera Data only for the following purposes:
        </p>
      ...
      <section id="genetic-data" className="mb-8">
        ...
        <ol className="list-[lower-alpha] list-outside ml-6 space-y-3 mb-4">
          ...
          <li>
            <strong>Return of Results:</strong> Rapidera has established clear policies regarding whether and under what circumstances genetic findings will be returned to individuals, including procedures for handling incidental findings of clinical significance.
          </li>
          <li>
      ...
      <section id="reporting" className="mb-8">
        ...
        <ol className="list-[lower-alpha] list-outside ml-6 space-y-3 mb-4">
          <li>
            <strong>Reporting Obligation:</strong> Users must immediately report any suspected or actual violations of this Policy, security incidents, unauthorized access to Rapidera Data, or any breach or unauthorized disclosure of Genetic Data.
          </li>
          <li>
          ...
          <li>
            <strong>No Retaliation:</strong> Rapidera prohibits retaliation against individuals who report violations in good faith.
          </li>
        </ol>
      </section>
