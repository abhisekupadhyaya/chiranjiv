...
export default function SampleReport() {
  ...
  return (
    <div className="min-h-screen bg-background relative flex flex-col items-center py-8 px-4 sm:px-6">
      {/* Close Button */}
      <Button
        variant="ghost"
        size="icon"
        className="fixed top-4 right-4 z-50 rounded-full bg-background/80 backdrop-blur-sm border shadow-sm hover:bg-accent"
      ...
      <div className="w-full max-w-6xl mx-auto">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-light text-foreground mb-2">Sample Health Report</h1>
          <p className="text-muted-foreground">Preview of the comprehensive insights you'll receive</p>
        </div>
